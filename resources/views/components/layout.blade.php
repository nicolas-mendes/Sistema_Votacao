        ...
        <nav class="relative items-center py-3 border-b border-white/25">
            <div class="relative w-full flex items-center h-16">
                ...
                <div>
                    <a href="/">
                        <img class="w-24"
                            src="https://upload.wikimedia.org/wikipedia/pt/3/3f/Neon-Genesis-Evangelion-Logo.jpg"
                            alt="logo">
                    </a>
                </div>
                ...
                <div class="hidden md:block absolute left-1/2 -translate-x-1/2">
                    <div class="space-x-6 font-semibold text-lg font-mont">
                        <a href="/pools" class="text-white hover:text-grape transition-colors duration-300">Listar
                            Enquetes</a>
                        <a href="/vote" class="text-white hover:text-grape transition-colors duration-300">Votar</a>
                        <a href="/create" class="text-white hover:text-grape transition-colors duration-300">Criar
                            Enquete</a>
                    </div>
                </div>
